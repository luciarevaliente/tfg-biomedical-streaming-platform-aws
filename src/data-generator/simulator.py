...
def main():
    parser = argparse.ArgumentParser(description='Biomedical data simulator — TFG Lucia Revaliente')
    parser.add_argument(
        '--scenario',
        choices=['base', 'sustained', 'peak', 'all'],
        default='all',
        help='Scenario to run. Use "all" to run all scenarios sequentially (default: all)'
    )
    ...
    for scenario_name, scenario_config in scenarios_to_run:
        logger.info(f"\n{'─' * 60}")
